...
class UtilsTests(DatatableViewTestCase):
    ...
    def test_resolve_orm_path_local(self):
        ...
        self.assertEqual(field, models.ExampleModel._meta.get_fields('name')[0])
    ...
    def test_resolve_orm_path_fk(self):
        ...
        self.assertEqual(remote_field, models.RelatedModel._meta.get_fields('name')[0])
    ...
    def test_resolve_orm_path_reverse_fk(self):
        ...
        self.assertEqual(remote_field, models.ReverseRelatedModel._meta.get_fields('name')[0])
    ...
    def test_resolve_orm_path_m2m(self):
        ...
        self.assertEqual(remote_field, models.RelatedM2MModel._meta.get_fields('name')[0])
    ...
    def test_structure_automatic_pretty_names(self):
        ...
        name_field = models.ExampleModel._meta.get_fields('name')[0]
